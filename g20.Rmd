---
title: "Brasil-G20, Dados Comerciais"
...
- \pagestyle{fancy}
- \fancyhead{}
- \fancyhead[CO,CE]{Brasil-G20, Dados Comerciais}
- \fancyfoot[CO,CE]{}
...
pais <- c("África do Sul", "Alemanha", "Arábia Saudita", "Argentina", "Austrália", "Canadá", "China", "Coreia do Sul", "Estados Unidos", "França", "Índia", "Indonésia", "Itália", "Japão", "México", "Reino Unido", "Rússia", "Turquia")
...
```{r, results='asis'}
purrr::walk(barao2::comerciobr_tabelas_comercio(pais, periodo), print)
```
